...
class Photo_geo_processor():
    ...
    def get_variants_list(self,filepath):
        ...
        text_combinations[2] = u'{filename} {suburb_ru}{extension}'
        text_combinations[3] = u'{state_en} {city_en} {road_en_translit} {filename}{extension}'
        text_combinations[4] = u'{state_ru} {city_ru} {road_ru} {filename}{extension}'
        text_combinations[5] = u'{city_ru} {road_ru} {filename}{extension}'
        ...
        gc['ru']['state'] = self._get_if_exist(overpass_data['address'], 'state') or ''
        gc['ru']['city'] = self._get_if_exist(overpass_data['address'], 'city') or self._get_if_exist(overpass_data['address'], 'town') or ''
        ...
        for index in text_combinations.keys():
            ...
            full_text = template.format(
                ...
                town_ru=gc['ru']['town'],
                city_en=gc['en']['city'],
                state_ru=gc['ru']['state'],
                state_en=gc['en']['state'],
    ...
    def ask_mode(self, filepath):
        ...
        texts = self.get_variants_list(filepath)
        for key in texts:
